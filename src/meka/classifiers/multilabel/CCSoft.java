...
import meka.classifiers.multilabel.cc.MyCNode;
import meka.core.A;
 ...
 */
public class CCSoft extends MultilabelClassifier implements Randomizable, TechnicalInformationHandler {
...
//			y[j] = nodes[j].classify((Instance)x.copy(),y); 			
			// Replaced classify by the estimated probability for each class
			y[j]=nodes[j].distribution((Instance)x.copy(),y)[1];
