...
import weka.filters.unsupervised.attribute.WordVSMMultiPartition;
import weka.filters.unsupervised.instance.RemoveWithValues;

public class CentroidPartitionExp {



	public CentroidPartitionExp(){
	...
	public void processDistFilt(Instances sourceData,WordVSMMultiPartition wcFilt) throws Exception{
...
//		this.evaluateDataSet(targetData3,trainWords );
	...
	static public void main(String args[]) throws Exception{
		...
		CentroidPartitionExp wlf=new CentroidPartitionExp();

		WordVSMMultiPartition distFiltNonEx=new WordVSMMultiPartition();		
		// Non mutually exclusive false			
		distFiltNonEx.setOptions(Utils.splitOptions("-M 0 -N 0 -W -C -I 3 -P WORD- -Q CLUST- -L -J lexicons/AFINN-posneg.txt  -H resources/50mpaths2.txt -R -T resources/stopwords.txt -O -U "+partitionSize));
		...
		System.out.println("Tweet Centroid with Partitions of size "+ partitionSize);
