...
public class RecCentRandEval {

	private String path; // input Path
	private String lexPath; // Path of destination Lex
	private WordDocRecCentRand recCentFilt;  // the TextToVSM Filter to be used 
	private int iterations; // defines the type of Filter to be used

	public RecCentRandEval(String path, int iterations, String lexPath){
		this.path=path;	
	...
	public void evalWordLevel() throws Exception{
		...
		System.out.println(" ,WordDocRecCentRand");



		this.recCentFilt=new WordDocRecCentRand();
		...
		this.recCentFilt.setOptions(Utils.splitOptions("-N 0  -I 3  -L -K -J lexicons/metaLexEmo.csv -R -S -T resources/stopwords.txt -O"));
	...
	static public void main(String args[]) throws Exception {
		...
		System.out.println("---------------------------------");
		RecCentRandEval vsmEv=new RecCentRandEval(args[0],Integer.parseInt(args[1]),args[2]);
		vsmEv.evalWordLevel();
