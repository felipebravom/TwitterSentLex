...
public class MyUtils {
	...
	public static Map<String,Double> evaluateSentiStrength(SentiStrength s, List<String> tokens){
			...
			String result = s.computeSentimentScores(sentence);
			...
			results.put("posScore",Double.parseDouble(values[0]));
			results.put("negScore",Double.parseDouble(values[1]));
